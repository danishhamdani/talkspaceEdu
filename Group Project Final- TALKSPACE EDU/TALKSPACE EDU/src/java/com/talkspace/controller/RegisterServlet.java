...
public class RegisterServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("student".equalsIgnoreCase(role)) {
            ...
            student.setRegId(request.getParameter("studentID"));
            student.setDepartment(request.getParameter("department"));
            
            isSuccess = dao.registerStudent(student);
            ...
            counselor.setRegId(request.getParameter("counselorID"));
            counselor.setSpecialization(request.getParameter("specialization"));
            
            isSuccess = dao.registerCounselor(counselor);
        }
